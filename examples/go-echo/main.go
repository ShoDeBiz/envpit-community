// Echo example — resolves config from a real EnvPit server through the PUBLISHED Go SDK
...
// Echo's own os.Getenv-based config, works completely untouched.
//
...
func main() {
	...
	addr := ":8082"
	log.Printf("echo example listening on %s — GET /config", addr)
